...
//                       <p className="font-medium text-lg">{product.price} DA</p>
...
//             <p className="text-lg/tight leading-7.5">{totalAmount.toFixed(2)} DA</p>
//           </div>
//         </div>
...
//         </div>
//         <span className={`${quantity === 10 ? "text-gray-400" : ""}`}>{quantity}</span>
//         <div
//           className="rounded-full w-full h-full flex justify-center items-center hover:bg-gray-200 cursor-pointer"
